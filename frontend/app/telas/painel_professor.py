...
from app.design_system.media import eh_imagem, id_video_youtube, url_thumb_youtube
...
from app.design_system.components.buttons import (
...
from app.infra.api_client import ApiError, Quiz
